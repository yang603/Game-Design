 ...
 */
public class Neutral extends Sprite {
    ...
    public Neutral(String path, int x, int y, double scope) {
        super();
        this.path = path;
        this.x = x;
        this.y = y;
...
//            sourceimage = new File("src\\image\\ships\\ship3.png");
        ...
        MapCord mc = new MapCord(x,y,scope);
        this.setCenter(new Point(mc.getX(),mc.getY()));
        this.setRadius(-100);
